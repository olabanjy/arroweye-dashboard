...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  useEffect(() => {
    ...
    const styleLoadHandler = () => {
      ...
      // Layers and popups can be mounted as soon as the style is ready. Waiting
      // for every remote tile to finish can otherwise leave the loading overlay
      // visible indefinitely on a slow or partially unavailable tile source.
      setIsLoaded(true);
    };
