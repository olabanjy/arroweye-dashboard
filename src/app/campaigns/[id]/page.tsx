        ...
        >
          <div className="flex flex-col gap-2">
            <div className="text-[#919393] flex items-center gap-[5px] text-[0.875rem]">
              <p className=" uppercase text-primary tracking-[.1rem]">
              ...
              {toggleNotifications ? (
                <div className="flex items-center">
                  <div className="">
                    <input
                      type="text"
                      className="font-[900] text-[45px] text-primary focus:outline-none"
                      value={content?.title}
                      onChange={(e) => {
                ...
                <p className="font-[700] text-[45px] text-primary flex-grow">
                ...
                <div className="flex space-x-[5px]">
                  ...
                  {hasAccess(userLoggedInProfile, ["Manager"]) && (
                    <div className="relative group">
                      <p
                        className="bg-[#ffdead] text-primary rounded-full w-[50px] h-[50px] flex items-center justify-center  text-center cursor-pointer"
                        onClick={showDialog}
                      >
