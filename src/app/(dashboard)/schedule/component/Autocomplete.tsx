  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      {showOptions && suggestions.length > 0 && (
        <div className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-zinc-200 bg-white shadow-lg dark:border-zinc-600 dark:bg-zinc-800">
          {suggestions.map((option, index) => (
            <div
              key={index}
              className="cursor-pointer px-4 py-2 font-SansFlex text-[14px] text-zinc-900 hover:bg-zinc-100 dark:text-zinc-100 dark:hover:bg-zinc-700"
