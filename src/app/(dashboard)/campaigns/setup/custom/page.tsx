      ...
      <div className="bg-[#F6F6F6] h-max py-7 text-gray-950 dark:bg-background dark:text-foreground">
        ...
        <div className="bg-white py-8 mx-5 px-5 lg:px-14 dark:bg-card dark:border dark:border-border">
          ...
          <div className="mt-10 flex flex-col gap-2">
            <p>Audience Reach</p>
            <div className="bg-gray-200 w-full h-1 rounded-full overflow-hidden dark:bg-muted">
              <div
          ...
          {Object.keys(selectedDistricts).length !== 0 && hasCreatedDraft && (
            <div className="flex justify-end">
              ...
              >
                <Image
                  className="p-8 bg-[#CAFF00] border border-[#000000] rounded-full dark:border-border"
                  src="/Vectorcart.svg"
                  alt="spinslogo"
                  width={86}
                  height={86}
