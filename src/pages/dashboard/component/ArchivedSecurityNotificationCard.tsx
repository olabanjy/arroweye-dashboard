...
interface ArchivedSecurityNotificationCardProps {
  timeAgo: string;
  message: string;
  highlight?: string;
  onDownload: () => void;
...
const ArchivedSecurityNotificationCard: FC<
  ArchivedSecurityNotificationCardProps
...
export default ArchivedSecurityNotificationCard;
