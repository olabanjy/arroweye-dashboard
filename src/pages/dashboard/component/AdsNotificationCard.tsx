...
const AdsNotificationCard: FC<AdsNotificationCardProps> = ({
  ...
  return (
    <div className="flex items-center gap-[10px] pb-[20px] border-b max-h-[120px]">
      <div className=" flex-shrink relative w-full h-full aspect-square ">
        <Image
      ...
      <div className="  flex-1 w-full">
        ...
        <div className="text-[16px] flex items-center gap-[10px] mt-[20px]">
          <div
